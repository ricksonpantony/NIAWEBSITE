...
import { Phone, Mail, MessageCircle, BookOpen, X } from 'lucide-react'
        ...
        >
          <div className="relative">
              ...
              {!isExpanded ? (
                <div className="flex items-center justify-between h-full">
                  ...
                  <button
                    ...
                    className="w-10 h-10 bg-nai-highlight rounded-full flex items-center justify-center text-white"
                  >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {quickActions.map((action, index) => (
                      <motion.button
                        ...
                        className={`${action.color} text-white rounded-xl p-4 flex flex-col items-center gap-2 hover:scale-105 transition-transform duration-200`}
            ...
            {!isExpanded && (
              <motion.button
                onClick={() => setIsExpanded(true)}
                className="absolute -top-2 right-4 w-12 h-12 bg-nai-highlight rounded-full shadow-lg flex items-center justify-center text-white"
